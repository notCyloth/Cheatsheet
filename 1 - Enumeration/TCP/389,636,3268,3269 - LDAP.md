Reference: https://hacktricks.wiki/en/network-services-pentesting/pentesting-ldap.html#anonymous-access
# Anonymous LDAP
...
## ldapsearch
Using ldapsearch to dump the users of ninetail.htb:
```
